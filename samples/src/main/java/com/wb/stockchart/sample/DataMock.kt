...
package com.wb.stockchart.sample

import android.content.Context
import com.wb.stockchart.entities.FLAG_LINE_STARTER
import com.wb.stockchart.entities.IKEntity
import com.wb.stockchart.entities.KEntity
import com.wb.stockchart.sample.sample3.data.ActiveChartKEntity
import com.wb.stockchart.sample.sample3.data.ActiveInfo
import com.wb.stockchart.sample.sample3.data.ActiveResponse
            ...
            context.assets.open(fileName).use { inputStream ->
                ...
                for (i in 0 until data.length()) {
                    ...
                    val kEntity = KEntity(
                        ...
                        item.optString("amount").toBigDecimalOrNull()
                    )
                    result.add(kEntity)
                }
            }
