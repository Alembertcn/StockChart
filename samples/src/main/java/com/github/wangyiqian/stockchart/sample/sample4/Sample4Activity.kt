...
class Sample4Activity : AppCompatActivity() {
    ...
    private fun initKChart() {
        ...
        kChartConfig.apply {
            ...
            // 指标线宽度
            indexStrokeWidth = DimensionUtil.dp2px(this@Sample4Activity, 0.5f).toFloat()
            ...
            // 图高度
            height = DimensionUtil.dp2px(this@Sample4Activity, 170f)
            ...
            highlightLabelLeft =
                HighlightLabelConfig(
                    textSize = DimensionUtil.sp2px(this@Sample4Activity, 10f).toFloat(),
                    bgColor = Color.parseColor("#A3A3A3"),
                    padding = DimensionUtil.dp2px(this@Sample4Activity, 5f).toFloat()
                )

            // 空心蜡烛边框宽度
            hollowChartLineStrokeWidth = DimensionUtil.dp2px(this@Sample4Activity, 1f).toFloat()
        }
    }
    ...
    private fun initVolumeChart() {
        ...
        volumeChartConfig.apply {
            // 图高度
            height = DimensionUtil.dp2px(this@Sample4Activity, 40f)
    ...
    private fun initMacdChart() {
        ...
        macdChartConfig.apply {
            // 图高度
            height = DimensionUtil.dp2px(this@Sample4Activity, 80f)
    ...
    private fun initCustomChart() {
        ...
        customChartConfig.apply {
            height = DimensionUtil.dp2px(this@Sample4Activity, 50f)
            bigLabel = "这是自定义子图示例"
        }
    }
