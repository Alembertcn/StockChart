 ...
 */
class QMChartFactory(stockChart: IStockChart, childChartConfig: QMChartConfig) :
    AbsChildChartFactory<QMChartConfig>(stockChart, childChartConfig) {

    override fun createChart() = QMChart(stockChart, childChartConfig)
