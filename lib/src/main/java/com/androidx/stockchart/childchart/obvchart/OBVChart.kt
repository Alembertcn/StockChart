...
import com.androidx.stockchart.entities.GestureEvent
 ...
 */
class OBVChart(stockChart: IStockChart, chartConfig: OBVChartConfig) :
    BaseChildChart<OBVChartConfig>(stockChart, chartConfig) {
