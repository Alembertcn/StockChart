...
package com.github.stockchart.childchart.kdjchart
...
class KdjChartConfig(
    ...
    // k线颜色
    var kLineColor: Int = com.github.stockchart.DEFAULT_KDJ_K_LINE_COLOR,
    // k线宽度
    var kLineStrokeWidth: Float = com.github.stockchart.DEFAULT_KDJ_K_LINE_STROKE_WIDTH,
    // d线颜色
    var dLineColor: Int = com.github.stockchart.DEFAULT_KDJ_D_LINE_COLOR,
    // d线宽度
    var dLineStrokeWidth: Float = com.github.stockchart.DEFAULT_KDJ_D_LINE_STROKE_WIDTH,
    // j线颜色
    var jLineColor: Int = com.github.stockchart.DEFAULT_KDJ_J_LINE_COLOR,
    // j线宽度
    var jLineStrokeWidth: Float = com.github.stockchart.DEFAULT_KDJ_J_LINE_STROKE_WIDTH,
    // 需要展示的指标配置
    var index: Index? = com.github.stockchart.DEFAULT_KDJ_INDEX
