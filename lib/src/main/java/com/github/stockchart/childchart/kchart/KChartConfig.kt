...
package com.github.stockchart.childchart.kchart
...
open class KChartConfig(
    ...
    // 长按时高亮线左侧标签配置
    var highlightLabelLeft: HighlightLabelConfig? = com.github.stockchart.DEFAULT_K_CHART_HIGHLIGHT_LABEL_LEFT,
    // 长按时高亮线顶部标签配置
    ...
    // 线形图的线条颜色
    var lineChartColor: Int = com.github.stockchart.DEFAULT_K_CHART_LINE_CHART_COLOR,
    // 线形图的线条宽度
    var lineChartStrokeWidth: Float = com.github.stockchart.DEFAULT_K_CHART_LINE_CHART_STROKE_WIDTH,
    // 山峰图线条颜色
    ...
    // 蜡烛图的中间线宽度
    var candleChartLineStrokeWidth: Float = com.github.stockchart.DEFAULT_K_CHART_CANDLE_CHART_LINE_STROKE_WIDTH,
    // 空心蜡烛图线条宽度
    var hollowChartLineStrokeWidth: Float = com.github.stockchart.DEFAULT_K_CHART_HOLLOW_CHART_LINE_STROKE_WIDTH,
    // 美国线图（竹节图）线条宽度
    var barChartLineStrokeWidth: Float = com.github.stockchart.DEFAULT_K_CHART_BAR_CHART_LINE_STROKE_WIDTH,
    // 成本线价格
    var costPrice: Float? = null,
    // 成本线颜色
    var costPriceLineColor: Int = com.github.stockchart.DEFAULT_K_CHART_COST_PRICE_LINE_COLOR,
    // 成本线宽度
    var costPriceLineWidth: Float = com.github.stockchart.DEFAULT_K_CHART_COST_PRICE_LINE_WIDTH,
    // 昨收线价格
    var preClosePrice: Float? = null,
    // 昨收线颜色
    var preCloseLineColor: Int = com.github.stockchart.DEFAULT_K_CHART_COST_PRICE_LINE_COLOR,
    // 昨收线宽度
    var preCloseLineWidth: Float = com.github.stockchart.DEFAULT_K_CHART_COST_PRICE_LINE_WIDTH,
    var preClosePriceLineEffect: PathEffect? = DashPathEffect(floatArrayOf(20f, 10f), 0f),
    // 指标线条宽度
    var indexStrokeWidth: Float = com.github.stockchart.DEFAULT_K_CHART_INDEX_STROKE_WIDTH,
    // 柱子之间的空间占比柱子宽度
    var barSpaceRatio: Float = com.github.stockchart.DEFAULT_K_CHART_BAR_SPACE_RATIO,
    // 需要展示的指标类型
    var index: Index? = com.github.stockchart.DEFAULT_K_CHART_INDEX,
    // 指标线的颜色
    var indexColors: List<Int> = com.github.stockchart.DEFAULT_K_CHART_INDEX_COLORS,
    // 左侧标签配置
    var leftLabelConfig: LabelConfig? = com.github.stockchart.DEFAULT_K_CHART_LEFT_LABEL_CONFIG,
    // 右侧标签配置
    var rightLabelConfig: LabelConfig? = null,
    // 是否显示分时均线。若需要显示，K线数据需带有分时均线价格。
    var showAvgLine: Boolean = false,
    // 分时均线颜色
    var avgLineColor: Int = com.github.stockchart.DEFAULT_AVG_LINE_COLOR,
    // 分时均线宽度
    var avgLineStrokeWidth: Float = com.github.stockchart.DEFAULT_AVG_LINE_WIDTH,
    ...
    sealed class KChartType(
        ...
        class CANDLE(
            highestAndLowestLabelConfig: HighestAndLowestLabelConfig = HighestAndLowestLabelConfig(
                ...
                com.github.stockchart.DEFAULT_K_CHART_HIGHEST_AND_LOWEST_LABEL_COLOR,
                com.github.stockchart.DEFAULT_K_CHART_HIGHEST_AND_LOWEST_LABEL_TEXT_SIZE,
                com.github.stockchart.DEFAULT_K_CHART_HIGHEST_AND_LOWEST_LABEL_LINE_STROKE_WIDTH,
                com.github.stockchart.DEFAULT_K_CHART_HIGHEST_AND_LOWEST_LABEL_LINE_LENGTH
            ),
