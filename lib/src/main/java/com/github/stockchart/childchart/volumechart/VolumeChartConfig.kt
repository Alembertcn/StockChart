...
package com.github.stockchart.childchart.volumechart
...
class VolumeChartConfig(
    ...
    chartMainDisplayAreaPaddingTop: Float = com.github.stockchart.DEFAULT_CHART_MAIN_DISPLAY_AREA_PADDING_TOP /2,
    ...
    // 柱子之间的空间占比柱子宽度
    var barSpaceRatio: Float = com.github.stockchart.DEFAULT_VOLUME_BAR_SPACE_RATIO,
    // 柱子空心时的线条宽度
    var hollowChartLineStrokeWidth: Float = com.github.stockchart.DEFAULT_VOLUME_CHART_HOLLOW_CHART_LINE_STROKE_WIDTH,
    ...
    // 指标文字颜色
    var indexTextColor: Int = com.github.stockchart.DEFAULT_INDEX_START_TEXT_COLOR,
    // 指标头文字点击事件
