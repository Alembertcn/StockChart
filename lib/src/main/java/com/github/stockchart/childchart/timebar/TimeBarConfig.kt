...
package com.github.stockchart.childchart.timebar
 ...
 */
class TimeBarConfig(
    height: Int = com.github.stockchart.DEFAULT_TIME_BAR_HEIGHT,
    ...
    // 背景色
    @ColorInt var backGroundColor: Int = com.github.stockchart.DEFAULT_TIME_BAR_BG_COLOR,
    // 标签文本大小
    var labelTextSize: Float = com.github.stockchart.DEFAULT_TIME_BAR_LABEL_TEXT_SIZE,
    // 标签文本色
    @ColorInt var labelTextColor: Int = com.github.stockchart.DEFAULT_TIME_BAR_LABEL_TEXT_SIZE_COLOR,
    // 长按显示的标签文本大小
    var highlightLabelTextSize: Float = com.github.stockchart.DEFAULT_TIME_BAR_HIGHLIGHT_LABEL_TEXT_SIZE,
    // 长按显示的标签文本色
    @ColorInt var highlightLabelTextColor: Int = com.github.stockchart.DEFAULT_TIME_BAR_HIGHLIGHT_LABEL_TEXT_COLOR,
    // 长按显示的标签背景色
    @ColorInt var highlightLabelBgColor: Int = com.github.stockchart.DEFAULT_TIME_BAR_HIGHLIGHT_LABEL_BG_COLOR,
    // 时间条样式
