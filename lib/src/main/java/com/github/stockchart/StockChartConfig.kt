...
import com.github.stockchart.listener.OnGestureListener
...
class StockChartConfig {
     ...
     */
    var scrollAble =
        com.github.stockchart.DEFAULT_SCROLL_ABLE

    /**
     * 是否支持"滑过头回弹"效果
     */
    var overScrollAble =
        com.github.stockchart.DEFAULT_OVER_SCROLL_ABLE

    /**
     * "滑过头回弹"最大距离
     */
    var overScrollDistance =
        com.github.stockchart.DEFAULT_OVER_SCROLL_DISTANCE

    /**
     * "滑过头回弹"过程中触发加载更多需要的距离
     */
    var overScrollOnLoadMoreDistance =
        com.github.stockchart.DEFAULT_OVER_SCROLL_ON_LOAD_MORE_DISTANCE

    /**
     * 是否支持双指缩放
     */
    var scaleAble =
        com.github.stockchart.DEFAULT_SCALE_ABLE

    /**
     * 是否需要"平滑的"滑动。如果false，滑动时一个下标对应的内容要么全显示，要么不显示。
     */
    var scrollSmoothly = com.github.stockchart.DEFAULT_SCROLL_SMOOTHLY

    /**
     * 超出滑动限制范围时拖动的"摩擦力"
     */
    var frictionScrollExceedLimit =
        com.github.stockchart.DEFAULT_FRICTION_SCROLL_EXCEED_LIMIT

    /**
     * 双指缩放最大缩放比例
     */
    var scaleFactorMax =
        com.github.stockchart.DEFAULT_SCALE_FACTOR_MAX
        set(value) {
     ...
     */
    var scaleFactorMin =
        com.github.stockchart.DEFAULT_SCALE_FACTOR_MIN
        set(value) {
    ...
    var showHighlightHorizontalLine =
        com.github.stockchart.DEFAULT_SHOW_HIGHLIGHT_HORIZONTAL_LINE

    /**
     * 长按高亮横线宽度
     */
    var highlightHorizontalLineWidth =
        com.github.stockchart.DEFAULT_HIGHLIGHT_HORIZONTAL_LINE_WIDTH

    /**
     * 长按高亮横线颜色
     */
    var highlightHorizontalLineColor =
        com.github.stockchart.DEFAULT_HIGHLIGHT_HORIZONTAL_LINE_COLOR
    ...
    var showHighlightVerticalLine =
        com.github.stockchart.DEFAULT_SHOW_HIGHLIGHT_VERTICAL_LINE

    /**
     * 长按高亮竖线宽度
     */
    var highlightVerticalLineWidth =
        com.github.stockchart.DEFAULT_HIGHLIGHT_VERTICAL_LINE_WIDTH

    /**
     * 长按高亮竖线颜色
     */
    var highlightVerticalLineColor =
        com.github.stockchart.DEFAULT_HIGHLIGHT_VERTICAL_LINE_COLOR
     ...
     */
    var riseColor: Int =
        com.github.stockchart.DEFAULT_RISE_COLOR

    /**
     * 跌色值
     */
    var downColor: Int =
        com.github.stockchart.DEFAULT_DOWN_COLOR

    /**
     * 背景色
     */
    @ColorInt
    var backgroundColor = com.github.stockchart.DEFAULT_BACKGROUND_COUNT

    /**
     * 背景网格横线数
     */
    var gridHorizontalLineCount = com.github.stockchart.DEFAULT_GRID_HORIZONTAL_LINE_COUNT

    /**
     * 背景网格竖线数
     */
    var gridVerticalLineCount = com.github.stockchart.DEFAULT_GRID_VERTICAL_LINE_COUNT

    /**
     * 背景网格线条色
     */
    @ColorInt
    var gridLineColor = com.github.stockchart.DEFAULT_GRID_LINE_COLOR

    /**
     * 背景网格线条宽度
     */
    var gridLineStrokeWidth = com.github.stockchart.DEFAULT_GRID_LINE_STROKE_WIDTH
    ...
    var valueTendToZero = com.github.stockchart.DEFAULT_VALUE_TEND_TO_ZERO
